<template>
  <div class="">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin: auto; background: transparent; display: block" :height="size" :width="size" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
      <defs>
        <filter id="ldio-uz2zvqbd99e-filter" x="-100%" y="-100%" width="300%" height="300%" color-interpolation-filters="sRGB">
      ...
      <g filter="url(#ldio-uz2zvqbd99e-filter)"><g transform="translate(50 50)">
      <g>
        <circle cx="17" cy="0" r="5" fill="#916c23">
      ...
      <g>
        <circle cx="17" cy="0" r="5" fill="#536b7c">
      ...
      <g>
        <circle cx="17" cy="0" r="5" fill="#686477">
      ...
      <g>
        <circle cx="17" cy="0" r="5" fill="#726078">
      ...
      <g>
        <circle cx="17" cy="0" r="5" fill="#8a6249">
